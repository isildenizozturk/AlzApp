  ...
  , [personTel])
    ...
    return (
      <DrawerContentScrollView {...props}>
        ...
        <DrawerItem style={{bottom: 0, position: 'absolute', width: '100%'}} icon={() => <AntDesign name='heart' size={16}></AntDesign>} label={() => <Text style={{ color: 'black' }}>Acil Yardım Butonu</Text>}
...
const AppStack = () => {
    ...
    <Drawer.Navigator screenOptions={{headerShown:true}} drawerContent={props => <CustomDrawerContent {...props} />}>
        <Drawer.Screen name='Home' component={HomeScreen} options={{headerTitle:'Ana Menü',title:'Ana Menü' ,drawerIcon: () => <Icon name='home' size={16}></Icon>}}>
